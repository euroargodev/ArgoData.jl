...
# ╔═╡ 08cdb840-3890-40a6-b86f-ad70c5da2e17
let
	(lo,la,te)=get_lon_lat_temp(df2)
	fig2=plot_lo_la_etc(lo,la; te=te, pol=pol)
end
...
manifest_format = "2.0"
project_hash = "11dae6c81e7c7d11978bc4ef7f5d1e1afcf19ea7"
...
git-tree-sha1 = "ea806c77bb0d76397ff8ca2a9fd850e3c8b098bd"
